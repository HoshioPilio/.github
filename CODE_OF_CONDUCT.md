...
This text is licensed under the CC-BY-4.0] (license license. It is based on a template established by the TODO Group and variants thereof used by numerous other large communities (e.g., Microsoft, Facebook, Yahoo, Twitter, GitHub) and the Scope section from the Contributor Covenant version 1.4.
